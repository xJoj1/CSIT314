<?php
include("editUserAcccontroller.php");
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="container mt-5">
  <div class="create-container">
      ...
      <form id="userForm" onsubmit="return validateForm()" method="post" action="editUserAcccontroller.php"> 
          <div class="form-group">
              <div class="row">
                  ...
                  <div class="col">
                      <input type="text" id="name" name="name" value="Enteruserhere">
                  </div>
              </div>
              <div class="row">
                  <div class="col-3">
          ...
          <div class="form-group">
              <div class="row">
                  ...
                  <div class="col">
                      <input type="text" id="user-id" name="user-id" value="EnteruserIDhere">
                  </div>
              </div>
              <div class="row">
                  <div class="col-3">
          ...
          <div class="form-group">
              <div class="row">
                  ...
                  <div class="col">
                      <input type="text" id="address" name="address" value="Sample Address Blk 444">
                  </div>
              </div>
              <div class="row">
                  <div class="col-3">
          ...
          <div class="form-group">
              <div class="row">
                  ...
                  <div class="col">
                      <input type="text" id="contact" name="contact" value="99125999">
                  </div>
              </div>
              <div class="row">
                  <div class="col-3">
