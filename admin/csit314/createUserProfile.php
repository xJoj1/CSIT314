<?php include ("createUserProfileController.php");
include ("config.php");
...
<!-- End of nav bar -->  
  ...
  <div class="container mt-5">
      <div class="create-container">
          ...
          <form id="profileForm" action="createUserProfileController.php" method="post" onsubmit="return validateForm()">
              ...
              <div class="form-group2">
                  <div class="row">
                    ...
                    <div class="col">
                        ...
                        <input type="text" id="role" name="role" value="Placeholder">
                    </div>
                </div>
              </div>
