<?php
    require_once '../../Controller/Buyer/savedSoldPropertyController.php';
    $controller = new savedSoldPropertyController();

    $properties = $controller->getSoldAnd1Properties();
                ...
                <div class="col-md-4 mb-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">
                <?php echo '$' . number_format($property['price']) . ' - ' . htmlspecialchars($property['size']) . ' sqft ' . htmlspecialchars($property['beds']) . ' bed ' . htmlspecialchars($property['baths']) . ' bathroom'; ?>
            </p>
