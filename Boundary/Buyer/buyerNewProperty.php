        ...
        <div class="row">
                ...
                <div class="filter-sidebar">
                    ...
                    <div class="range-group">
                        ...
                        <div class="price-range-labels">
                            <span id="lowerPriceLabel"></span> - <span id="upperPriceLabel"></span>
                        </div>
                    </div>
                    <button class="btn filter-button">Apply Filters</button>
                </div>
            </div>
            ...
            <div class="col-md-8">
                ...
                <div class="search-container-with-filter">
                    <label><b>Search Property Listing</b></label>
...
<script>
    ...
    function applyFilters() {
        ...
        console.log('Filtering properties from $' + prices[0] + ' to $' + prices[1]);
    }
</script>
