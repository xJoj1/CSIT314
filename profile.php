                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-5 col-md-12">
                                ...
                                <div class="user-info mt-md-50"> 
                                    <img src="admin/user/<?php echo $userData['uimage'];?>" alt="userimage">
                                    <div class="mb-4 mt-3">
                                        <div class="font-18">
                                            <div class="mb-1 text-capitalize"><b>Name:</b> <?php echo $userData['uname'];?></div>
                                            <div class="mb-1"><b>Email:</b> <?php echo $userData['uemail'];?></div>
                                            <div class="mb-1"><b>Contact:</b> <?php echo $userData['uphone'];?></div>
                                            <div class="mb-1 text-capitalize"><b>Role:</b> <?php echo $userData['utype'];?></div>
                                        </div>
                                    </div>
                                </div>
